			...
			<div class="container">
				...
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						@if(Auth::check())
						<li><a href="{{route('trang-chu')}}"><i class="fa fa-user"></i>Chào bạn {{Auth::user()->full_name}} </a></li>
					...
					<div class="beta-comp">
						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-item">
									<a class="cart-item-delete" href="{{route('xoahang',$product['item']['id'])}}"><i class="fa fa-times"></i></a>
									<div class="media">
