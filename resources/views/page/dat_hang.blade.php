									...
									<!--  one item	 -->
										<div class="media">
											...
											<div class="media-body">
												...
												<span class="color-gray your-order-info">Số lượng : {{number_format($product['qty'])}}</span>
												<span class="color-gray your-order-info">đơn giá : {{number_format($product['price']/$product['qty'])}} đồng</span>
											</div>
										</div>
									<!-- end one item -->
									@endforeach
