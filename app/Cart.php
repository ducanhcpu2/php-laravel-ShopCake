...
class Cart
{
	...
	public function add($item, $id){
		...
		// if($item->promotion_price =! 0) $unit_or_promotion_price = $item->promotion_price;
		// $giohang = ['qty'=>0, 'price' => $unit_or_promotion_price, 'item' => $item];
		// if($this->items){
		...
		// $this->totalQty++;
		// $this->totalPrice += $unit_or_promotion_price;
			$giohang = ['qty'=>0, 'price' => $item->unit_or_promotion_price, 'unit_price' => $item->unit_price,
